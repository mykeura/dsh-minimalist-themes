window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = "._vQTkW_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}._vQTkW_card:hover{border-color:var(--dsw-alias-label-dimmed)}._vQTkW_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}._vQTkW_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}._vQTkW_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}._vQTkW_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}._vQTkW_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}._vQTkW_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}._vQTkW_pending{white-space:nowrap;background:var(--mt-accent);color:var(--dsw-alias-label-primary);border-radius:999px;flex:none;align-items:center;gap:6px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px;display:inline-flex}._vQTkW_pendingDot{background:var(--dsw-alias-label-primary);opacity:.55;border-radius:50%;width:6px;height:6px}._vQTkW_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}._vQTkW_chevronOpen{transform:rotate(180deg)}._vQTkW_body{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:12px;margin:0 16px;padding:12px 0 8px;display:flex}._vQTkW_reset{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background var(--ds-transition-duration-fast) var(--ds-ease-in-out), border-color var(--ds-transition-duration-fast) var(--ds-ease-in-out), color var(--ds-transition-duration-fast) var(--ds-ease-in-out);background:0 0;border-radius:999px;align-self:flex-start;padding:5px 12px;font-size:12px;line-height:16px}._vQTkW_reset:hover{background:var(--dsw-alias-interactive-bg-hover)}._vQTkW_resetSelected{border-color:var(--dsw-alias-brand-primary);color:var(--dsw-alias-brand-primary);background:var(--dsw-specific-bubble)}._vQTkW_reset:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}._vQTkW_grid{grid-template-columns:repeat(auto-fill,minmax(128px,1fr));gap:10px;display:grid}._vQTkW_swatch{--mt-accent:#cfd3d6;--mt-canvas:#fff;--mt-field:#f9fafb;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);cursor:pointer;text-align:left;transition:border-color var(--ds-transition-duration-fast) var(--ds-ease-in-out), box-shadow var(--ds-transition-duration-fast) var(--ds-ease-in-out), transform var(--ds-transition-duration-fast) var(--ds-ease-in-out);border-radius:10px;flex-direction:column;gap:8px;padding:8px;display:flex}._vQTkW_swatch:hover{box-shadow:0 2px 8px var(--dsw-alias-bg-mask-2);transform:translateY(-1px)}._vQTkW_swatch:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}._vQTkW_selected{border-color:var(--dsw-alias-brand-primary);box-shadow:0 0 0 1px var(--dsw-alias-brand-primary)}._vQTkW_bands{border:1px solid var(--dsw-alias-border-l1);border-radius:6px;flex-direction:column;height:56px;display:flex;overflow:hidden}._vQTkW_bandAccent{background:var(--mt-accent);flex:3}._vQTkW_bandCanvas{background:var(--mt-canvas);flex:5}._vQTkW_bandField{background:var(--mt-field);flex:2}._vQTkW_swatchName{color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;font-size:12px;line-height:16px;overflow:hidden}";
		...
		var ThemesCard_module_css_default = {
			"pendingDot": "_vQTkW_pendingDot",
			"pending": "_vQTkW_pending",
			"bandAccent": "_vQTkW_bandAccent",
			"bandCanvas": "_vQTkW_bandCanvas",
			"bands": "_vQTkW_bands",
			"resetSelected": "_vQTkW_resetSelected",
			"chevron": "_vQTkW_chevron",
			"name": "_vQTkW_name",
			"chevronOpen": "_vQTkW_chevronOpen",
			"body": "_vQTkW_body",
			"cardOpen": "_vQTkW_cardOpen",
			"headText": "_vQTkW_headText",
			"description": "_vQTkW_description",
			"grid": "_vQTkW_grid",
			"selected": "_vQTkW_selected",
			"swatch": "_vQTkW_swatch",
			"card": "_vQTkW_card",
			"bandField": "_vQTkW_bandField",
			"swatchName": "_vQTkW_swatchName",
			"header": "_vQTkW_header",
			"reset": "_vQTkW_reset"
		};
		//#endregion
