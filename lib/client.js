window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region ../../contenedores/dsh/deepseek-harness/node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs
		function r(e) {
			var t, f, n = "";
		...
		//#endregion
		//#region \0mt-css:/home/miguel/Documentos/Desarrollador/Deepseek Harness/dsh-minimalist-themes/src/client/ThemesCard.module.css.mjs
		const css = ".Z2HoRG_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.Z2HoRG_card:hover{border-color:var(--dsw-alias-label-dimmed)}.Z2HoRG_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.Z2HoRG_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.Z2HoRG_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.Z2HoRG_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.Z2HoRG_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.Z2HoRG_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.Z2HoRG_pending{white-space:nowrap;background:var(--mt-frame);color:var(--dsw-alias-label-primary);border-radius:999px;flex:none;align-items:center;gap:6px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px;display:inline-flex}.Z2HoRG_pendingDot{background:var(--dsw-alias-label-primary);opacity:.55;border-radius:50%;width:6px;height:6px}.Z2HoRG_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.Z2HoRG_chevronOpen{transform:rotate(180deg)}.Z2HoRG_body{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:12px;margin:0 16px;padding:12px 0 8px;display:flex}.Z2HoRG_reset{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background var(--ds-transition-duration-fast) var(--ds-ease-in-out), border-color var(--ds-transition-duration-fast) var(--ds-ease-in-out), color var(--ds-transition-duration-fast) var(--ds-ease-in-out);background:0 0;border-radius:999px;align-self:flex-start;padding:5px 12px;font-size:12px;line-height:16px}.Z2HoRG_reset:hover{background:var(--dsw-alias-interactive-bg-hover)}.Z2HoRG_resetSelected{border-color:var(--dsw-alias-brand-primary);color:var(--dsw-alias-brand-primary);background:var(--dsw-specific-bubble)}.Z2HoRG_reset:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}.Z2HoRG_grid{grid-template-columns:repeat(auto-fill,minmax(128px,1fr));gap:10px;display:grid}.Z2HoRG_swatch{--mt-frame:#cfd3d6;--mt-canvas:#fff;--mt-omnibox:#f9fafb;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);cursor:pointer;text-align:left;transition:border-color var(--ds-transition-duration-fast) var(--ds-ease-in-out), box-shadow var(--ds-transition-duration-fast) var(--ds-ease-in-out), transform var(--ds-transition-duration-fast) var(--ds-ease-in-out);border-radius:10px;flex-direction:column;gap:8px;padding:8px;display:flex}.Z2HoRG_swatch:hover{box-shadow:0 2px 8px var(--dsw-alias-bg-mask-2);transform:translateY(-1px)}.Z2HoRG_swatch:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}.Z2HoRG_selected{border-color:var(--dsw-alias-brand-primary);box-shadow:0 0 0 1px var(--dsw-alias-brand-primary)}.Z2HoRG_bands{border:1px solid var(--dsw-alias-border-l1);border-radius:6px;flex-direction:column;height:56px;display:flex;overflow:hidden}.Z2HoRG_bandFrame{background:var(--mt-frame);flex:3}.Z2HoRG_bandCanvas{background:var(--mt-canvas);flex:5}.Z2HoRG_bandOmnibox{background:var(--mt-omnibox);flex:2}.Z2HoRG_swatchName{color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;font-size:12px;line-height:16px;overflow:hidden}";
		const tagId = "@mykeura/dsh-minimalist-themes/ThemesCard.module.css";
		...
		var ThemesCard_module_css_default = {
			"headText": "Z2HoRG_headText",
			"bands": "Z2HoRG_bands",
			"swatchName": "Z2HoRG_swatchName",
			"name": "Z2HoRG_name",
			"pending": "Z2HoRG_pending",
			"cardOpen": "Z2HoRG_cardOpen",
			"pendingDot": "Z2HoRG_pendingDot",
			"body": "Z2HoRG_body",
			"selected": "Z2HoRG_selected",
			"card": "Z2HoRG_card",
			"description": "Z2HoRG_description",
			"chevron": "Z2HoRG_chevron",
			"grid": "Z2HoRG_grid",
			"bandCanvas": "Z2HoRG_bandCanvas",
			"chevronOpen": "Z2HoRG_chevronOpen",
			"resetSelected": "Z2HoRG_resetSelected",
			"reset": "Z2HoRG_reset",
			"header": "Z2HoRG_header",
			"swatch": "Z2HoRG_swatch",
			"bandOmnibox": "Z2HoRG_bandOmnibox",
			"bandFrame": "Z2HoRG_bandFrame"
		};
		//#endregion
